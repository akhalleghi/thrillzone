...
<head>
    ...
    <title>ویدیو آموزشی - منطقه هیجان</title>
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            <h1 class="main-title">ویدیوی آموزشی</h1>
            <p class="subtitle">
                با تماشای این ویدیو، با نحوه استفاده از خدمات ما و قابلیت‌های ویژه «منطقه هیجان» آشنا شوید.
            </p>

            <div class="video-container">
                <div class="video-wrapper">
                    <iframe src="https://www.aparat.com/video/video/embed/videohash/fmh7z2u/vt/frame?titleShow=true" allowFullScreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                </div>
            </div>
        </div>
    </div>
